...
//cpp_jail
	...
	system($cmd,$result);
	echo "Result: $result \n";
	$cmd = "cp -R /home/$user/jails/cpp_jail/home/$user /home/$user/$contest/cpp_jail/home/$user";
	system($cmd,$result);
	echo "Result: $result \n";
//c_jail	
	...
	system($cmd,$result);
	echo "Result: $result \n";
	$cmd = "cp -R /home/$user/jails/c_jail/home/$user /home/$user/$contest/c_jail/home/$user";
	system($cmd,$result);
	echo "Result: $result \n";
