...
$sql = "insert into TEAMS (TEAM_NAME, ORGANIZATION, USERNAME, PASSWORD, SITE_ID, COACH_NAME, CONTESTANT_1_NAME, CONTESTANT_2_NAME, CONTESTANT_3_NAME, ALTERNATE_NAME, EMAIL) values('a', 'a', 'a', 'a', '1', 'a', 'one', 'two', 'three', 'alt', 'a')";
$result = mysql_query($sql);
